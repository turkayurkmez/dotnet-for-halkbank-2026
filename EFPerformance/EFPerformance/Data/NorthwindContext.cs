...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<IxUsageReport> IxUsageReports { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IxUsageReport>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("IX_Usage_Report");

            entity.Property(e => e.GuncellemeMaaliyeti).HasColumnName("guncelleme_maaliyeti");
            entity.Property(e => e.IndexAdi).HasMaxLength(128);
            ...
            entity.Property(e => e.LookupSayisi).HasColumnName("lookupSayisi");
            entity.Property(e => e.ScanSayisi).HasColumnName("scanSayisi");
            entity.Property(e => e.SeekSayisi).HasColumnName("seekSayisi");
            entity.Property(e => e.TabloAdi)
                .HasMaxLength(128)
                .HasColumnName("tabloAdi");
            entity.Property(e => e.TipAciklamasi)
                .HasMaxLength(60)
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.HasIndex(e => e.CustomerId, "IX_Orders_CustomerId_Covering");
